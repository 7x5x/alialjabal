...
<head>
  ...
  <script type="text/javascript">
    (function () {
      emailjs.init("oy_a_4aeupDI2yePn");
    })();
  </script>
    ...
    <aside class="sidebar" data-sidebar>
      ...
      <div class="sidebar-info">
        ...
        <figure class="avatar-box">
          <img src="./assets/images/my-avatar.png" alt="Ali Al-Jabal" width="80">
        </figure>

        <div class="info-content">
          <h1 class="name" title="Ali Al-Jabal">Ali Al-Jabal</h1>
          ...
          <ul class="social-list">
            ...
            <li class="social-item">
              <a href="https://www.facebook.com/profile.php?id=100011583289007" class="social-link">
            ...
            <li class="social-item">
              <a href="https://www.instagram.com/_7x5x" class="social-link">
        ...
        <ul class="contacts-list">
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <a href="mailto:alialjabal4@gmail.com" class="contact-link">alialjabal4@gmail.com</a>
            </div>
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <a href="tel:+967734290666" class="contact-link">+967 (734) 290 666</a>
            </div>
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <time datetime="2000-5-30">May 30, 2000</time>
            </div>
